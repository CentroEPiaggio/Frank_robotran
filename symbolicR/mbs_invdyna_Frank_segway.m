...
% Backward Dynamics 
  ...
  Cq117 = -(s.trq(1,17)-s.In(1,17)*(C17*(OMp16-qd(17)*OM36)-S17*(OMp36+qd(17)*OM16))+OM217*OM317*(s.In(5,17)-s.In(9,17)));
  Cq217 = -(s.trq(2,17)-s.In(5,17)*(qdd(17)+OMp26)-OM117*OM317*(s.In(1,17)-s.In(9,17)));
  Cq317 = -(s.trq(3,17)-s.In(9,17)*(C17*(OMp36+qd(17)*OM16)+S17*(OMp16-qd(17)*OM36))+OM117*OM217*(s.In(1,17)-s.In(5,17)));
  ...
  Cq116 = -(s.trq(1,16)-s.In(1,16)*(C16*(OMp16-qd(16)*OM36)-S16*(OMp36+qd(16)*OM16))+OM216*OM316*(s.In(5,16)-s.In(9,16)));
  Cq216 = -(s.trq(2,16)-s.In(5,16)*(qdd(16)+OMp26)-OM116*OM316*(s.In(1,16)-s.In(9,16)));
  Cq316 = -(s.trq(3,16)-s.In(9,16)*(C16*(OMp36+qd(16)*OM16)+S16*(OMp16-qd(16)*OM36))+OM116*OM216*(s.In(1,16)-s.In(5,16)));
  ...
  Fs113 = -(s.frc(1,13)+s.m(13)*(s.l(2,13)*(OMp313-OM113*OM213)-s.l(3,13)*(OMp213+OM113*OM313)-C13*(ALPHA111+BETA312*s.dpt(3,15))-S13*(ALPHA212+...
 BETA612*s.dpt(3,15))));
  Fs213 = -(s.frc(2,13)+s.m(13)*(s.l(2,13)*(OM113*OM113+OM313*OM313)-s.l(3,13)*(BS613-OMp113)-C13*(ALPHA212+BETA612*s.dpt(3,15))+S13*(ALPHA111+...
 BETA312*s.dpt(3,15))));
  Fs313 = -(s.frc(3,13)-s.m(13)*(ALPHA312+BS912*s.dpt(3,15)+s.l(2,13)*(BS613+OMp113)-s.l(3,13)*(OM113*OM113+OM213*OM213)));
  ...
  Fq312 = Fs312+Fs313;
  Cq112 = -(s.trq(1,12)-s.In(1,12)*OMp112-Cq113*C13+Cq213*S13+Fs212*s.l(3,12)+OM212*OM312*(s.In(5,12)-s.In(9,12))+s.dpt(3,15)*(Fs113*S13+Fs213*...
 C13));
  Cq212 = -(s.trq(2,12)-s.In(5,12)*OMp212-Cq113*S13-Cq213*C13-Fs112*s.l(3,12)+Fs312*s.l(1,12)-OM112*OM312*(s.In(1,12)-s.In(9,12))-s.dpt(3,15)*(...
 Fs113*C13-Fs213*S13));
  ...
  Cq211 = -(s.trq(2,11)-s.In(5,11)*OMp211-Cq212*C12+Cq312*S12+Fs311*s.l(1,11)-OM111*OM311*(s.In(1,11)-s.In(9,11)));
  Cq311 = -(s.trq(3,11)-s.In(9,11)*OMp311-Cq212*S12-Cq312*C12+Fs111*s.l(2,11)-Fs211*s.l(1,11)+OM111*OM211*(s.In(1,11)-s.In(5,11)));
  Fs110 = -(s.frc(1,10)+s.m(10)*(s.l(2,10)*(OMp310-OM110*OM210)-s.l(3,10)*(OMp210+OM110*OM310)-C10*(ALPHA18+BETA39*s.dpt(3,11))-S10*(ALPHA29+...
 BETA69*s.dpt(3,11))));
  Fs210 = -(s.frc(2,10)+s.m(10)*(s.l(2,10)*(OM110*OM110+OM310*OM310)-s.l(3,10)*(BS610-OMp110)-C10*(ALPHA29+BETA69*s.dpt(3,11))+S10*(ALPHA18+...
 BETA39*s.dpt(3,11))));
  Fs310 = -(s.frc(3,10)-s.m(10)*(ALPHA39+BS99*s.dpt(3,11)+s.l(2,10)*(BS610+OMp110)-s.l(3,10)*(OM110*OM110+OM210*OM210)));
  ...
  Fq39 = Fs310+Fs39;
  Cq19 = -(s.trq(1,9)-s.In(1,9)*OMp19-Cq110*C10+Cq210*S10+Fs29*s.l(3,9)+OM29*OM39*(s.In(5,9)-s.In(9,9))+s.dpt(3,11)*(Fs110*S10+Fs210*C10));
  Cq29 = -(s.trq(2,9)-s.In(5,9)*OMp29-Cq110*S10-Cq210*C10-Fs19*s.l(3,9)+Fs39*s.l(1,9)-OM19*OM39*(s.In(1,9)-s.In(9,9))-s.dpt(3,11)*(Fs110*C10-...
 Fs210*S10));
  ...
  Cq38 = -(s.trq(3,8)-s.In(9,8)*OMp38-Cq29*S9-Cq39*C9+Fs18*s.l(2,8)-Fs28*s.l(1,8)+OM18*OM28*(s.In(1,8)-s.In(5,8)));
  ...
  Fq37 = -(s.frc(3,14)+s.frc(3,7)-s.m(14)*ALPHA314-s.m(7)*ALPHA37+Fq111*S11+Fq18*S8-Fq311*C11-Fq38*C8+Fs115*S15-Fs315*C15);
  ...
  Fq26 = -(s.frc(2,16)+s.frc(2,17)-Fq27-Fs26-s.m(16)*(ALPHA26+BS56*s.dpt(2,3))-s.m(17)*(ALPHA26+BS56*s.dpt(2,4)));
  Fq36 = Fq37+Fs36-Fs116*S16-Fs117*S17+Fs316*C16+Fs317*C17;
  Cq16 = -(s.trq(1,6)+s.trq(1,7)-s.In(1,6)*OMp16-s.In(1,7)*OMp16-Cq111*C11-Cq114*C14-Cq116*C16-Cq117*C17-Cq18*C8+Cq214*S14-Cq311*S11-Cq316*S16-...
 Cq317*S17-Cq38*S8+Dz73*Fq27-Fs36*s.l(2,6)+OM26*OM36*(s.In(5,6)-s.In(9,6))+OM26*OM36*(s.In(5,7)-s.In(9,7))+s.dpt(2,3)*(Fs116*S16-Fs316*C16)+s.dpt(2,4)...
 *(Fs117*S17-Fs317*C17)+s.dpt(2,6)*(Fq18*S8-Fq38*C8)+s.dpt(2,7)*(Fq111*S11-Fq311*C11)+s.dpt(3,8)*(Fq114*S14+Fq214*C14));
  Cq26 = -(s.trq(2,6)+s.trq(2,7)-Cq211-Cq216-Cq217-Cq28-s.In(5,6)*OMp26-s.In(5,7)*OMp26-Cq114*S14-Cq214*C14-Dz73*Fq17+Fs36*s.l(1,6)-OM16*OM36*(...
 s.In(1,6)-s.In(9,6))-OM16*OM36*(s.In(1,7)-s.In(9,7))-s.dpt(3,8)*(Fq114*C14-Fq214*S14));
  Cq36 = -(s.trq(3,6)+s.trq(3,7)-Cq314-s.In(9,6)*OMp36-s.In(9,7)*OMp36+Cq111*S11+Cq116*S16+Cq117*S17+Cq18*S8-Cq311*C11-Cq316*C16-Cq317*C17-Cq38*...
 C8+Fs16*s.l(2,6)-Fs26*s.l(1,6)+OM16*OM26*(s.In(1,6)-s.In(5,6))+OM16*OM26*(s.In(1,7)-s.In(5,7))+s.dpt(2,3)*(Fs116*C16+Fs316*S16)+s.dpt(2,4)*(Fs117*C17...
 +Fs317*S17)+s.dpt(2,6)*(Fq18*C8+Fq38*S8)+s.dpt(2,7)*(Fq111*C11+Fq311*S11));
