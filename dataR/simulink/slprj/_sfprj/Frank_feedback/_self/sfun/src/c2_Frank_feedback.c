...
static const char * c2_debug_family_names[22] = { "CoM_v", "sens_values",
  "m_tot", "j", "i", "S", "x_ax", "z_ax", "Sb", "Rz", "CoM_rel", "nargin",
  "nargout", "psi_1", "q", "qd", "qdd", "rob_str", "Ts", "psi", "psi_dot", "CoM"
};
  ...
  *chartInstance)
{
  ...
  int32_T c2_i14;
  real_T c2_b_qdd[17];
  c2_struct_ZwdsKLYK9S2KrT5tyDKoxE c2_c_rob_str;
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 12U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_psi_1, 13U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_q, 14U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_qd, 15U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_qdd, 16U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_rob_str, 17U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_Ts, 18U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  ...
  for (c2_i11 = 0; c2_i11 < 17; c2_i11++) {
    c2_x[c2_i11] = c2_b_rob_str.m[c2_i11];
  }
  ...
  c2_sensor_measurements(chartInstance, c2_c_q, c2_c_qd, c2_c_qdd, &c2_d_rob_str,
    1.0, &c2_r2);
  c2_Sb = c2_r2;
  ...
  c2_j_y = c2_i_y;
  c2_q_x = c2_p_x;
  c2_psi = muDoubleScalarAtan2(c2_j_y, c2_q_x);
  ...
  c2_t_x = c2_s_x;
  c2_m_y = c2_l_y;
  c2_psi_dot = c2_t_x / c2_m_y;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, -49);
  _SFD_SYMBOL_SCOPE_POP();
  *c2_b_psi = c2_psi;
  *c2_b_psi_dot = c2_psi_dot;
  for (c2_i33 = 0; c2_i33 < 3; c2_i33++) {
    (*c2_b_CoM)[c2_i33] = c2_CoM[c2_i33];
  }
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  for (c2_i34 = 0; c2_i34 < 3; c2_i34++) {
    c2_b_inData[c2_i34] = (*(real_T (*)[3])c2_inData)[c2_i34];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i37 = 0; c2_i37 < 3; c2_i37++) {
    (*(real_T (*)[3])c2_outData)[c2_i37] = c2_y[c2_i37];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i38 = 0; c2_i38 < 57; c2_i38++) {
    c2_b_u[c2_i38] = c2_u.dpt[c2_i38];
  }
  ...
  real_T c2_y[57])
{
  ...
  int32_T c2_i40;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv9, 1, 0, 0U, 1, 0U, 2, 3, 19);
  for (c2_i40 = 0; c2_i40 < 57; c2_i40++) {
    c2_y[c2_i40] = c2_dv9[c2_i40];
  }
  ...
  real_T c2_y[17])
{
  ...
  int32_T c2_i41;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv10, 1, 0, 0U, 1, 0U, 2, 1,
                17);
  for (c2_i41 = 0; c2_i41 < 17; c2_i41++) {
    c2_y[c2_i41] = c2_dv10[c2_i41];
  }
  ...
  *c2_inData)
{
  ...
  chartInstance = (SFc2_Frank_feedbackInstanceStruct *)chartInstanceVoid;
  c2_mxArrayOutData = NULL;
  for (c2_i42 = 0; c2_i42 < 17; c2_i42++) {
    c2_b_inData[c2_i42] = (*(real_T (*)[17])c2_inData)[c2_i42];
  }

  for (c2_i43 = 0; c2_i43 < 17; c2_i43++) {
  ...
  *c2_inData)
{
  ...
  for (c2_i45 = 0; c2_i45 < 3; c2_i45++) {
    for (c2_i46 = 0; c2_i46 < 3; c2_i46++) {
      c2_b_inData[c2_i46 + c2_i44] = (*(real_T (*)[9])c2_inData)[c2_i46 + c2_i44];
    }
  ...
  real_T c2_y[102])
{
  ...
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv12, 1, 0, 0U, 1, 0U, 2, 6,
                17);
  for (c2_i61 = 0; c2_i61 < 102; c2_i61++) {
    c2_y[c2_i61] = c2_dv12[c2_i61];
  }
  ...
  real_T c2_y[17])
{
  ...
  int32_T c2_i62;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv13, 1, 0, 0U, 1, 0U, 1, 17);
  for (c2_i62 = 0; c2_i62 < 17; c2_i62++) {
    c2_y[c2_i62] = c2_dv13[c2_i62];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i63 = 0; c2_i63 < 17; c2_i63++) {
    (*(real_T (*)[17])c2_outData)[c2_i63] = c2_y[c2_i63];
  }
  ...
  real_T c2_A[9], real_T c2_B[3], real_T c2_C[3])
{
  ...
  for (c2_i78 = 0; c2_i78 < 3; c2_i78++) {
    ...
    for (c2_i80 = 0; c2_i80 < 3; c2_i80++) {
      c2_C[c2_i78] += c2_A[c2_i79 + c2_i78] * c2_B[c2_i80];
      c2_i79 += 3;
    }
  }
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(393401322U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3818267348U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2309064627U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1562460286U);
}
...
mxArray *sf_c2_Frank_feedback_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("SmTbZjVtLv98Q2MNnUk1TB");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,1,"sensor_measurements",1229,-1,61980);
        _SFD_CV_INIT_EML_FOR(0,1,0,208,220,425);
        _SFD_CV_INIT_EML_FOR(0,1,1,224,237,421);

        {
          static int caseStart[] = { -1, 2619, 4248, 7516, 12256, 17629, 25082,
            29946, 35524, 43208, 48075, 51838, 55796, 58888 };

          static int caseExprEnd[] = { 8, 2625, 4254, 7522, 12262, 17635, 25088,
            29952, 35530, 43214, 48082, 51845, 55803, 58895 };

          _SFD_CV_INIT_EML_SWITCH(0,1,0,2600,2613,61979,14,&(caseStart[0]),
            &(caseExprEnd[0]));
        }
...
static void mdlSetWorkWidths_c2_Frank_feedback(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(452187604U));
  ssSetChecksum1(S,(1045803838U));
  ssSetChecksum2(S,(4144342103U));
  ssSetChecksum3(S,(4202311866U));
