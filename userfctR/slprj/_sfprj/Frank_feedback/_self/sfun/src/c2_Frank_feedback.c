...
static const char * c2_debug_family_names[23] = { "CoM_v", "sens_values",
  "m_tot", "j", "i", "S", "x_ax", "z_ax", "Sb", "Rz", "CoM_rel", "CoM_v_rel",
  "nargin", "nargout", "psi_1", "q", "qd", "qdd", "rob_str", "Ts", "psi",
  "psi_dot", "CoM" };
  ...
  *chartInstance)
{
  ...
  real_T c2_x_ax[3];
  real_T c2_z_ax[3];
  c2_s3P2Hgr8IQaO66xIl8CEZeB c2_Sb;
  real_T c2_Rz[9];
  real_T c2_CoM_rel[3];
  real_T c2_CoM_v_rel[3];
  ...
  int32_T c2_i19;
  real_T c2_c_qdd[17];
  c2_struct_ZwdsKLYK9S2KrT5tyDKoxE c2_e_rob_str;
  c2_s3P2Hgr8IQaO66xIl8CEZeB c2_r2;
  real_T c2_g_x;
  real_T c2_h_x;
  real_T c2_i_x;
  real_T c2_j_x;
  ...
  c2_d_qdd = (real_T (*)[17])ssGetInputPortSignal(chartInstance->S, 3);
  c2_d_qd = (real_T (*)[17])ssGetInputPortSignal(chartInstance->S, 2);
  c2_d_q = (real_T (*)[17])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c2_i6 = 0; c2_i6 < 17; c2_i6++) {
    c2_q[c2_i6] = (*c2_d_q)[c2_i6];
  }

  for (c2_i7 = 0; c2_i7 < 17; c2_i7++) {
    c2_qd[c2_i7] = (*c2_d_qd)[c2_i7];
  }

  for (c2_i8 = 0; c2_i8 < 17; c2_i8++) {
    c2_qdd[c2_i8] = (*c2_d_qdd)[c2_i8];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_CoM_v, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(NULL, 1U, c2_g_sf_marshallOut,
    c2_f_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_i, 4U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_S, 5U, c2_f_sf_marshallOut,
    c2_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_x_ax, 6U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_z_ax, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_Sb, 8U, c2_f_sf_marshallOut,
    c2_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_Rz, 9U, c2_e_sf_marshallOut,
    c2_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_CoM_rel, 10U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_CoM_v_rel, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 13U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_psi_1, 14U, c2_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_q, 15U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_qd, 16U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c2_qdd, 17U, c2_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_rob_str, 18U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_Ts, 19U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_psi, 20U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_psi_dot, 21U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c2_CoM, 22U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  for (c2_i15 = 0; c2_i15 < 3; c2_i15++) {
    c2_x_ax[c2_i15] = c2_dv1[c2_i15];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 23);
  for (c2_i16 = 0; c2_i16 < 3; c2_i16++) {
    c2_z_ax[c2_i16] = c2_dv2[c2_i16];
  }

  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 33);
  for (c2_i17 = 0; c2_i17 < 17; c2_i17++) {
    c2_c_q[c2_i17] = c2_q[c2_i17];
  }

  for (c2_i18 = 0; c2_i18 < 17; c2_i18++) {
    c2_c_qd[c2_i18] = c2_qd[c2_i18];
  }

  for (c2_i19 = 0; c2_i19 < 17; c2_i19++) {
    c2_c_qdd[c2_i19] = c2_qdd[c2_i19];
  }
  ...
  for (c2_i23 = 0; c2_i23 < 3; c2_i23++) {
    ...
    for (c2_i25 = 0; c2_i25 < 3; c2_i25++) {
      c2_a[c2_i25 + c2_i22] = c2_Rz[c2_i24 + c2_i23];
      c2_i24 += 3;
    }
  ...
  for (c2_i26 = 0; c2_i26 < 3; c2_i26++) {
    c2_b[c2_i26] = c2_CoM[c2_i26] - c2_Sb.P[c2_i26];
  }

  c2_eml_scalar_eg(chartInstance);
  c2_eml_scalar_eg(chartInstance);
  for (c2_i27 = 0; c2_i27 < 3; c2_i27++) {
    c2_CoM_rel[c2_i27] = 0.0;
  }

  for (c2_i28 = 0; c2_i28 < 3; c2_i28++) {
    c2_CoM_rel[c2_i28] = 0.0;
  }

  for (c2_i29 = 0; c2_i29 < 9; c2_i29++) {
    c2_dv4[c2_i29] = c2_a[c2_i29];
  }

  for (c2_i30 = 0; c2_i30 < 3; c2_i30++) {
    c2_dv5[c2_i30] = c2_b[c2_i30];
  }

  for (c2_i31 = 0; c2_i31 < 9; c2_i31++) {
    c2_dv6[c2_i31] = c2_dv4[c2_i31];
  }

  for (c2_i32 = 0; c2_i32 < 3; c2_i32++) {
    c2_dv7[c2_i32] = c2_dv5[c2_i32];
  }

  c2_b_eml_xgemm(chartInstance, c2_dv6, c2_dv7, c2_CoM_rel);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 37);
  c2_i33 = 0;
  for (c2_i34 = 0; c2_i34 < 3; c2_i34++) {
    c2_i35 = 0;
    for (c2_i36 = 0; c2_i36 < 3; c2_i36++) {
      c2_a[c2_i36 + c2_i33] = c2_Rz[c2_i35 + c2_i34];
      c2_i35 += 3;
    }
  ...
  for (c2_i37 = 0; c2_i37 < 3; c2_i37++) {
    c2_b[c2_i37] = c2_CoM_v[c2_i37] - c2_Sb.V[c2_i37];
  }

  c2_eml_scalar_eg(chartInstance);
  c2_eml_scalar_eg(chartInstance);
  for (c2_i38 = 0; c2_i38 < 3; c2_i38++) {
    c2_CoM_v_rel[c2_i38] = 0.0;
  }

  for (c2_i39 = 0; c2_i39 < 3; c2_i39++) {
    c2_CoM_v_rel[c2_i39] = 0.0;
  }

  for (c2_i40 = 0; c2_i40 < 9; c2_i40++) {
    c2_dv8[c2_i40] = c2_a[c2_i40];
  }

  for (c2_i41 = 0; c2_i41 < 3; c2_i41++) {
    c2_dv9[c2_i41] = c2_b[c2_i41];
  }

  for (c2_i42 = 0; c2_i42 < 9; c2_i42++) {
    c2_dv10[c2_i42] = c2_dv8[c2_i42];
  }

  for (c2_i43 = 0; c2_i43 < 3; c2_i43++) {
    c2_dv11[c2_i43] = c2_dv9[c2_i43];
  }

  c2_b_eml_xgemm(chartInstance, c2_dv10, c2_dv11, c2_CoM_v_rel);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 48);
  c2_i_y = c2_CoM_rel[0];
  c2_o_x = c2_CoM_rel[2];
  c2_j_y = c2_i_y;
  c2_p_x = c2_o_x;
  c2_psi = muDoubleScalarAtan2(c2_j_y, c2_p_x);
  ...
  *c2_inData)
{
  ...
  for (c2_i49 = 0; c2_i49 < 57; c2_i49++) {
    c2_b_u[c2_i49] = c2_u.dpt[c2_i49];
  }
  ...
  real_T c2_y[57])
{
  ...
  int32_T c2_i51;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv13, 1, 0, 0U, 1, 0U, 2, 3,
                19);
  for (c2_i51 = 0; c2_i51 < 57; c2_i51++) {
    c2_y[c2_i51] = c2_dv13[c2_i51];
  }
  ...
  real_T c2_y[17])
{
  ...
  int32_T c2_i52;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv14, 1, 0, 0U, 1, 0U, 2, 1,
                17);
  for (c2_i52 = 0; c2_i52 < 17; c2_i52++) {
    c2_y[c2_i52] = c2_dv14[c2_i52];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i53 = 0; c2_i53 < 17; c2_i53++) {
    c2_b_inData[c2_i53] = (*(real_T (*)[17])c2_inData)[c2_i53];
  }
  ...
  *c2_inData)
{
  ...
  for (c2_i56 = 0; c2_i56 < 3; c2_i56++) {
    for (c2_i57 = 0; c2_i57 < 3; c2_i57++) {
      c2_b_inData[c2_i57 + c2_i55] = (*(real_T (*)[9])c2_inData)[c2_i57 + c2_i55];
    }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i63 = 0; c2_i63 < 3; c2_i63++) {
    for (c2_i64 = 0; c2_i64 < 3; c2_i64++) {
      (*(real_T (*)[9])c2_outData)[c2_i64 + c2_i62] = c2_y[c2_i64 + c2_i62];
    }
  ...
  real_T c2_y[102])
{
  ...
  int32_T c2_i72;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv16, 1, 0, 0U, 1, 0U, 2, 6,
                17);
  for (c2_i72 = 0; c2_i72 < 102; c2_i72++) {
    c2_y[c2_i72] = c2_dv16[c2_i72];
  }
  ...
  real_T c2_y[17])
{
  ...
  int32_T c2_i73;
  (void)chartInstance;
  sf_mex_import(c2_parentId, sf_mex_dup(c2_u), c2_dv17, 1, 0, 0U, 1, 0U, 1, 17);
  for (c2_i73 = 0; c2_i73 < 17; c2_i73++) {
    c2_y[c2_i73] = c2_dv17[c2_i73];
  }
  ...
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData)
{
  ...
  for (c2_i74 = 0; c2_i74 < 17; c2_i74++) {
    (*(real_T (*)[17])c2_outData)[c2_i74] = c2_y[c2_i74];
  }
  ...
  c2_s3P2Hgr8IQaO66xIl8CEZeB *c2_sens)
{
  ...
  switch ((int32_T)_SFD_INTEGER_CHECK("isens", c2_isens)) {
   ...
   case 5:
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 619);
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 699);
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 702);
    ...
    c2_sens->J[27] = -c2_S4;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 772);
    c2_sens->J[33] = c2_ROcp4_15;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 773);
    c2_sens->J[45] = c2_ROcp4_46;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 774);
    c2_sens->J[51] = c2_ROcp4_18;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 775);
    c2_sens->J[57] = c2_ROcp4_79;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 776);
    c2_sens->J[28] = c2_C4;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 777);
    c2_sens->J[34] = c2_ROcp4_25;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 778);
    c2_sens->J[46] = c2_ROcp4_56;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 779);
   ...
   case 7:
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 939);
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 950);
   ...
   case 12:
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1703);
    c2_sens->R[0] = c2_ROcp11_116;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1704);
    c2_sens->R[3] = c2_ROcp11_216;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1705);
    c2_sens->R[6] = c2_ROcp11_316;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1706);
   ...
   case 13:
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1764);
    c2_RLcp12_117 = c2_ROcp12_46 * c2_s->dpt[10];
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1765);
    c2_RLcp12_217 = c2_ROcp12_56 * c2_s->dpt[10];
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1766);
    c2_RLcp12_317 = c2_ROcp12_66 * c2_s->dpt[10];
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1767);
    ...
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1793);
    c2_sens->R[0] = c2_ROcp12_117;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1794);
    c2_sens->R[3] = c2_ROcp12_217;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1795);
    c2_sens->R[6] = c2_ROcp12_317;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 1796);
  ...
  real_T c2_A[9], real_T c2_B[3], real_T c2_C[3])
{
  ...
  for (c2_i89 = 0; c2_i89 < 3; c2_i89++) {
    ...
    for (c2_i91 = 0; c2_i91 < 3; c2_i91++) {
      c2_C[c2_i89] += c2_A[c2_i90 + c2_i89] * c2_B[c2_i91];
      c2_i90 += 3;
    }
  }
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(753128528U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3197306761U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1108866494U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3823122664U);
}
...
mxArray *sf_c2_Frank_feedback_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QXmbevftkuxiKeJfBbrZID");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,1,"sensor_measurements",1228,-1,61979);
        _SFD_CV_INIT_EML_FOR(0,1,0,208,220,425);
        _SFD_CV_INIT_EML_FOR(0,1,1,224,237,421);

        {
          static int caseStart[] = { -1, 2618, 4247, 7515, 12255, 17628, 25081,
            29945, 35523, 43207, 48074, 51837, 55795, 58887 };

          static int caseExprEnd[] = { 8, 2624, 4253, 7521, 12261, 17634, 25087,
            29951, 35529, 43213, 48081, 51844, 55802, 58894 };

          _SFD_CV_INIT_EML_SWITCH(0,1,0,2599,2612,61978,14,&(caseStart[0]),
            &(caseExprEnd[0]));
        }
...
static void mdlSetWorkWidths_c2_Frank_feedback(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3066751304U));
  ssSetChecksum1(S,(2062548249U));
  ssSetChecksum2(S,(2660949620U));
  ssSetChecksum3(S,(2640826289U));
